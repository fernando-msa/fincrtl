...
3. **Fechamento de definição de pronto P0/P1**
   - ✅ Checklist de release publicado em `docs/release-checklist.md`.
   - ✅ Validação automática inicial adicionada via `npm run check:release` no CI.
   - 🔜 Próximo passo: incluir critérios de aceite de UX responsiva no mesmo gate.
